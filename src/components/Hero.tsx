  ...
  return (
    <section className="min-h-screen flex items-center justify-center pt-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 w-2 h-32 bg-gradient-to-b from-blue-500/30 to-transparent rotate-12 animate-fade-in delay-500"></div>
        <div className="absolute top-40 right-20 w-1 h-24 bg-gradient-to-b from-indigo-500/30 to-transparent -rotate-12 animate-fade-in delay-700"></div>
        <div className="absolute bottom-40 left-1/4 w-px h-16 bg-gradient-to-b from-purple-500/30 to-transparent animate-fade-in delay-1000"></div>
      </div>

      <div className="max-w-4xl mx-auto text-center relative z-10">
        <div className="mb-8 animate-scale-in">
          <div className="w-32 h-32 mx-auto mb-8 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-white text-4xl font-bold shadow-2xl hover:shadow-blue-500/25 transition-all duration-500 hover:scale-110 group">
            <span className="group-hover:scale-110 transition-transform duration-300">SD</span>
          </div>
        </div>
        
        <div className="space-y-6">
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 leading-tight animate-fade-in">
            Hi, I'm{' '}
          ...
          <h2 className="text-xl sm:text-2xl lg:text-3xl text-gray-600 font-medium animate-fade-in delay-300">
            Final Year B.Tech Student – Specializing in{' '}
            <span className="text-blue-600 font-semibold relative">
              Data Science
              <div className="absolute -bottom-1 left-0 w-full h-0.5 bg-gradient-to-r from-blue-600 to-indigo-600 animate-scale-in delay-500"></div>
            </span>
          </h2>
          
          <p className="text-lg sm:text-xl text-gray-500 max-w-2xl mx-auto animate-fade-in delay-500">
        ...
        <div className="mt-16 animate-bounce delay-1000">
          <ArrowDown className="mx-auto text-blue-600 hover:text-indigo-600 transition-colors duration-300 cursor-pointer" size={32} />
        </div>
      </div>
    </section>
  );
